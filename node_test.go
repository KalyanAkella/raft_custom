...
func TestDisableProposalForwarding(t *testing.T) {
	r1 := newTestRaft(1, []uint64{1, 2, 3}, 10, 1, newEntryStorage())
	r2 := newTestRaft(2, []uint64{1, 2, 3}, 10, 1, newEntryStorage())
	cfg3 := newTestConfig(3, []uint64{1, 2, 3}, 10, 1, newEntryStorage())
...
func TestNodeReadIndexToOldLeader(t *testing.T) {
	r1 := newTestRaft(1, []uint64{1, 2, 3}, 10, 1, newEntryStorage())
	r2 := newTestRaft(2, []uint64{1, 2, 3}, 10, 1, newEntryStorage())
	r3 := newTestRaft(3, []uint64{1, 2, 3}, 10, 1, newEntryStorage())
